...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('/api/rooms/', formData, { headers: { Authorization: `Bearer ${await getToken()}` } })
      ...
      <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
        ...
        <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
          <div className='flex-1 max-w-48'>
            ...
            <select value={inputs.valueType} onChange={e => setInputs({ ...inputs, roomType: e.target.value })} className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full'>
